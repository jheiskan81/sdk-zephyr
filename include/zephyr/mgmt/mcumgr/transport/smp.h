...
struct smp_client_transport_entry {
	...
	/** Transport type */
	enum smp_transport_type smpt_type;
};
 ...
 *
 * @return		Pointer to registred object. Unknown type return NULL.
 */
struct smp_transport *smp_client_transport_get(enum smp_transport_type smpt_type);
